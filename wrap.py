...
import os
import random
pygame.font.init() # Thiết lập font chữ

# Thiết lập cửa sổ
WIDTH = 750; HEIGHT = 750
WIN = pygame.display.set_mode((WIDTH, HEIGHT))
pygame.display.set_caption("Spacewar Game") #caption
...
class Ship:
    ...
    def __init__(self, x, y, health=100):
        ...
        self.laser_img = None
        self.lasers = []
        self.cool_down_counter = 0 # Bộ đếm: người dùng cần một khoảng thời gian trước khi được bắn tiếp
...
# Tàu của player kế thừa từ class ship
class Player(Ship):
    def __init__(self, x, y, health=100):
    ...
    def move_laser(self, vel, objs):
        ...
        for laser in self.lasers:
            ...
            if laser.off_screen(HEIGHT):
                ...
                # Kiểm tra xem tàu địch có tàu nào va chạm với cú bắn không
                for obj in objs:
...
def main():
    ...
    lost = False
    lost_count = 0
    main_font = pygame.font.SysFont("comicsans", 50) # Font chữ
    lost_font = pygame.font.SysFont("comicsans", 60)  # Font chữ
    enemy_vel = 1
    enemies = []
    wave_length = 5
    laser_vel = 4
    player_vel = 5 # vận tốc
    ...
    while run:
        ...
        for enemy in enemies[:]:
            ...
            # Tạo xác suất bắn của kẻ địch (random giá trị nếu = 1 thì mới bắn)
